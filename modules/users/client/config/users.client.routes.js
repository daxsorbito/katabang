  ...
  function ($stateProvider) {
    ...
    $stateProvider
      ...
      .state('settings.services', {
        ...
        templateUrl: 'modules/users/views/settings/edit-profile-services.client.view.html'
      })
      .state('settings.address', {
        url: '/profile-address',
        templateUrl: 'modules/users/views/settings/edit-profile-address.client.view.html'
      })
